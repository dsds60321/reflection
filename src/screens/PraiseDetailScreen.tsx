  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background.primary }]}>
      ...
      <View style={[styles.footer, { borderTopColor: colors.background.cardSecondary }]}>
        <TouchableOpacity
          style={[styles.actionButton, styles.editButton, { borderColor: colors.primary.yellow }]}
          onPress={handleEdit}
        >
          <MaterialCommunityIcons name="pencil" size={16} color={colors.primary.yellow} />
          <Text style={[styles.actionButtonText, { color: colors.primary.yellow }]}>수정</Text>
        </TouchableOpacity>
